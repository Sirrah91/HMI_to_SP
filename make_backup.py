...
# pipreqs --encoding utf-8 --ignore TB_log,accuracy_test,figures,log,models,python_compiled,torque,tuning_HP ./
...
def make_backup(version: str) -> None:
    ...
    # directories in _project_dir
    dirs_to_save_all = {path.join(_subdirs["models"], "composition"),
