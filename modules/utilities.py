...
def plot_me(x: np.ndarray | list, *args, backend: str = "TkAgg", **kwargs) -> tuple:
    ...
    Returns:
    - fig, ax: tuple containing the matplotlib Figure and Axes objects of the plot.
...
def standardize(array: np.ndarray, axis: int | None = None, num_eps: float = _num_eps,) -> np.ndarray:
    array_mean, array_std = return_mean_std(array, axis=axis)
